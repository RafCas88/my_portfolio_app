                    ...
                    <div className="col-md-6 col-md-offset-3 col-md-pull-3 col-sm-12 col-xs-12 js-fullheight slider-text">
                      <div className="slider-text-inner js-fullheight">
                        <div className="desc">
                          ...
                          href="https://drive.google.com/file/d/1opiUdEdvJwVofGpRtFDLcwJxrmPM4gYJ/view?usp=sharing"
                    ...
                    <div className="col-md-6 col-md-offset-3 col-md-pull-3 col-sm-12 col-xs-12 js-fullheight slider-text">
                      <div className="slider-text-inner">
                        <div className="desc">
                          ...
                          <p><a className="btn btn-primary btn-learn" href="https://github.com/RafCas88"
